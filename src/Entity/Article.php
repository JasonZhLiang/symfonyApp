...
class Article
{
    //instead of creating createAt and updateAt manually,
     ...
     * @ORM\Column(type="integer")
     */
    private $heartCount = 0;//give a default value
...
//            ;
        //move above logic code to repository class
    ...
    public function validate(ExecutionContextInterface $context, $payload)
    {
        if (stripos($this->getTitle(),'the borg') !== false){
            $context->buildViolation('Um.. the borg kinda makes us us nervous')
                ->atPath('title')
                ->addViolation();
        }
    }
